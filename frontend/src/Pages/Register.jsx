...
import avatar from '../images/avatars/addAvatar.png'
            ...
            <div className="login-container-fluid text-center">
                <div className="login-container">
                    ...
                    <div className="login-content mb-3">
                        ...
                        <h5 className="sub-heading mb-5">Sign Up</h5>
                        <form className="form row needs-validation mt-4" noValidate>
                            <div className="col-md-12 mb-4">
                                <div className="form-floating has-validation">
                                    <input type="text" className="form-control" id="floatingDisplayName" placeholder="Display Name" required />
                            ...
                            <div className="col-md-12 mb-4">
                                ...
                                <label htmlFor="file">
                                    <img src={avatar} className='pe-2' width='50px' height='50px' alt="" />
                            ...
                            <div>You do have an account?<Link to='/login' className='ms-2'>Login</Link></div>
                        </form>
                    </div>
                </div>
            </div>
